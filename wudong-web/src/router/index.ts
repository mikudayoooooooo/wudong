...
export function createAppRouter(): Router {
  return createRouter({
    ...
    routes: [
      ...
      { path: '/farm-products/:id', component: () => import('../views/food/FarmProductDetailView.vue') },
      { path: '/cart', component: () => import('../views/cart/CartView.vue'), meta: { requiresAuth: true } },
      { path: '/order/:orderNo', component: () => import('../views/order/OrderDetailView.vue'), meta: { requiresAuth: true } },
      { path: '/post/:id', component: () => import('../views/PostDetailView.vue') },
      { path: '/my/orders', component: () => import('../views/my/MyOrdersView.vue'), meta: { requiresAuth: true } },
      { path: '/my/reservations', component: () => import('../views/my/MyReservationsView.vue'), meta: { requiresAuth: true } },
      { path: '/my/favorites', component: () => import('../views/my/MyFavoritesView.vue'), meta: { requiresAuth: true } },
