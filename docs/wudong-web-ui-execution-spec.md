...
- **进度总览（2026-09-11 收官）**：3.0 ✅ ／ 3.1 ✅ ／ 3.2 ✅ ／ 3.3 ✅ ／ 3.4 ✅ ／ 3.5 ✅ ／ 3.6 ✅ ／ 3.7 A+B+C ✅。**全部批次完成。**
- **遗留命名债（非视觉问题）**：`components/ai/*`（AI 管家演示壳）仍用 --green-*/--orange-* 别名——别名已映射新色板，视觉即靛蓝；组件迁移后可删 theme.css 别名段。农产品「茶/蜂蜜/竹编」题材缺图，待 probe-images 补图。
