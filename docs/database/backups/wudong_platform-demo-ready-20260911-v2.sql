-- ============================================================
-- 乌东演示库全量快照 v2（2026-09-11 晚）——取代同目录 demo-ready-20260911.sql（可从历史找回）
-- 时点：管理端收口合并 + 路线A路演重灌 + C端路线3/收货地址校准 + 孤儿数据清理后
-- 恢复：docker exec -i wudong-mysql mysql --default-character-set=utf8mb4 -uroot -p123456 wudong_platform < 本文件
-- 注意：恢复覆盖现库；全新机器重建走 setup-demo.sh（seed.js 为代码化真源）
-- ============================================================
...
INSERT INTO `cart_item` VALUES (4,'2026-09-11 19:01:59','2026-09-11 19:01:59',NULL,42,1,1,1,'苗族银饰手镯',328.00,'https://dummyimage.com/200x200/eee/888.png&text=yin'),(5,'2026-09-11 19:01:59','2026-09-11 19:01:59',NULL,42,2,2,2,'土蜂蜜',65.50,'https://dummyimage.com/200x200/eee/888.png&text=feng');
...
INSERT INTO `user_address` VALUES (5,'13800000001','2026-09-11 18:18:07','2026-09-11 18:18:07',NULL,42,'山野小鱼',1,'贵州省','黔东南苗族侗族自治州','雷山县','乌东村一组吊脚楼'),(6,'13800000001','2026-09-11 18:18:07','2026-09-11 18:18:07',NULL,42,'山野小鱼',0,'贵州省','贵阳市','观山湖区','贵阳北站东广场');
...
-- Dump completed on 2026-09-11 19:57:21
