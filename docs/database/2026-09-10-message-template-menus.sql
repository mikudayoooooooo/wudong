...
-- 对应后端：message 模块 /admin/messageTemplate CRUD + /admin/message/sendByTemplate
...
DELETE FROM base_sys_menu WHERE perms IN ('messageTemplate:page', 'messageTemplate:list', 'messageTemplate:info', 'messageTemplate:add', 'messageTemplate:update', 'messageTemplate:delete', 'message:sendByTemplate');
...
(NOW(), NOW(), @tpl, '模板查询', NULL, 'messageTemplate:page', 2, 1, 1, 0),
(NOW(), NOW(), @tpl, '模板列表', NULL, 'messageTemplate:list', 2, 2, 1, 0),
(NOW(), NOW(), @tpl, '模板详情', NULL, 'messageTemplate:info', 2, 3, 1, 0),
(NOW(), NOW(), @tpl, '模板新增', NULL, 'messageTemplate:add', 2, 4, 1, 0),
(NOW(), NOW(), @tpl, '模板编辑', NULL, 'messageTemplate:update', 2, 5, 1, 0),
(NOW(), NOW(), @tpl, '模板删除', NULL, 'messageTemplate:delete', 2, 6, 1, 0);
